...
else
{
	...
	$result1 = mysqli_query($conn,"INSERT INTO customer_details
		(fname, lname, email, password, mobile, created_date, otp, field_1, field_2, field_9)
	VALUES('$get_fname', '$get_lname', '$get_email', '$get_password', '$get_mobile',
	'$get_created_date', '$get_otp', '$get_field_1', '$get_field_2','$get_field_9')");
