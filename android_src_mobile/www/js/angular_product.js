...
/****************************************************************************/
	...
	{		
		$http.post('https://myapphosting.in/android/kaiyin/user_register.php', {'fname': $scope.reg_fname, 'lname':$scope.reg_lname, 'email':$scope.reg_email, 'password': $scope.reg_password, 'mobile': $scope.reg_mobile})
	...
	{		
		$http.post('https://myapphosting.in/android/kaiyin/vendor_register.php', {'fname': $scope.reg_fname, 'lname':$scope.reg_lname, 'email':$scope.reg_email, 'password': $scope.reg_password, 
...
/****************************************************************************/
	...
	$scope.log_user_email = $cookieStore.get("log_user_email");
		...
		$http.post('https://myapphosting.in/android/kaiyin/myproducts_get.php',{'email':$scope.log_user_email}	)
		.success(function(data, status, headers, config)  
		{
...
/**************************************************************************************/
	$scope.add_product= function() 
	{
		...
		$scope.discount ="Nil";
		$http.post('https://myapphosting.in/android/kaiyin/products_add.php',{
...
/****************************************************************************/
	...
	{		
        $http.post('https://myapphosting.in/android/kaiyin/delete.php', 
		{
	...
	{		
        $http.post('https://myapphosting.in/android/kaiyin/delete_category.php', 
		{
		'cus_id': cus_id
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{
		$http.post('https://myapphosting.in/android/kaiyin/product_update.php', {
		...
		$http.post('https://myapphosting.in/android/kaiyin/orders_get.php')
		.success(function(data, status, headers, config)
		{
	...
	$scope.radio = function(status)
	{
		...
		$http.post('https://myapphosting.in/android/kaiyin/orders_update.php',{'status': $scope.radio_status, 
...
$scope.address_more = function(customer_id) 
	...
	$scope.cook_customer_id = $cookieStore.get("cook_customer_id");
		...
		$http.post('https://myapphosting.in/android/kaiyin/get_address_order.php',{'email': $scope.cook_customer_id})
		.success(function(data, status, headers, config)
		{
...
/****************************************************************************/
	...
	{
	$http.post('https://myapphosting.in/android/kaiyin/save_shipping.php', {
	...
	$http.post('https://myapphosting.in/android/kaiyin/get_category.php')
	.success(function(data, status, headers, config)  
	{
			$scope.all_category = data.products;
	});

	$http.post('https://myapphosting.in/android/kaiyin/get_all_category.php')
	.success(function(data, status, headers, config)  
	{
			$scope.my_category = data.details;
	});
	
	$http.post('https://myapphosting.in/android/kaiyin/get_locality.php')
	.success(function(data, status, headers, config)  
	{
			$scope.all_locality = data.details;
	});

	$http.post('https://myapphosting.in/android/kaiyin/get_sub_category.php')
	.success(function(data, status, headers, config)  
	{
...
/****************************************************************************/
	...
	$http.post('https://myapphosting.in/android/kaiyin/products_get.php')
	.success(function(data, status, headers, config)  
	{
		if(data.success == 1)
		{
...
/****************************************************************************/	
	...
	$http.post('https://myapphosting.in/android/kaiyin/feedback_get.php',{'email':$scope.p_id})
	.success(function(data, status, headers, config)  
	{
			$scope.get_feedback_details = data.details;
	});
	
	$http.post('https://myapphosting.in/android/kaiyin/get_all_feedback.php')
	.success(function(data, status, headers, config)  
	{
			$scope.all_feedback_details = data.details;
	});
		
	$http.post('https://myapphosting.in/android/kaiyin/get_user.php')
	.success(function(data, status, headers, config)  
	{
...
/****************************************************************************/
	...
	{		
        $http.post('https://myapphosting.in/android/kaiyin/products_delete.php', 
		{
		'product_id': product_id
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	$http.post('https://myapphosting.in/android/kaiyin/category_get.php',{'product':$scope.product_name})
	.success(function(data, status, headers, config)  
	{
		if(data.success == 1)
		{
...
/*****************************************************************************/
	...
	{		
		...
		{
			$http.post('https://myapphosting.in/android/kaiyin/cart_add.php', {'product_id': $scope.p_id, 'email':$scope.log_user_email})
			.success(function(data, status, headers, config) 
			{
				if(data.success == 1)
				{
...
$scope.update_status_con = function(cus_id,field_9) 
	...
	{		
		$http.post('https://myapphosting.in/android/kaiyin/update_status.php',{
	...
	{		
        $http.post('https://myapphosting.in/android/kaiyin/delete_review.php', 
		{
		'cus_id': cus_id
		})
		.success(function(data, status, headers, config) 
...
$scope.edit_category = function(cus_id,field_1,field_2) 
	...
	{
	$http.post('https://myapphosting.in/android/kaiyin/save_category.php', {
	...
	{
	$http.post('https://myapphosting.in/android/kaiyin/add_solution.php', 
		{
