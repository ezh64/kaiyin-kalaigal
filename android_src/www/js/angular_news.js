...
/****************************************************************************/	
	...
	$http.post('http://10.0.2.2/projects/kaiyinkalaigal/web/admin_details.php', {'email': $scope.bn_adm_email})
...
/****************************************************************************/
	// All Products
	$http.get('http://10.0.2.2/projects/kaiyinkalaigal/web/news_get.php')
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/kaiyinkalaigal/web/news_delete.php', 
		{
		'client_id': client_id
		})
		.success(function(data, status, headers, config) 
