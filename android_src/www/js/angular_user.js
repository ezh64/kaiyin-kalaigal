...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/kaiyinkalaigal/web/send_otp_verify.php', 
	...
	{		
        $http.post('http://10.0.2.2/projects/kaiyinkalaigal/web/send_otp_verify_2.php', 
...
/****************************************************************************/
	...
	{		
	   ...
	   $http.post('http://10.0.2.2/projects/kaiyinkalaigal/web/user_verification.php', {'email': $scope.reg_user_email, 'otp':$scope.user_otp})
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
			{
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/kaiyinkalaigal/web/create_dept.php', 
		{
	...
	$http.post('http://10.0.2.2/projects/kaiyinkalaigal/web/get_dept.php', 
		{
